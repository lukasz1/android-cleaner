        ...
        if (TextUtils.isEmpty(packageName)) {
            for (int i = 0; i < pInfos.size(); i++) {
                ...
                Log.i(this.getClass().getName(),
                        "process name: " + pInfos.get(i).processName + " PID: "
                                + pInfos.get(i).pid
                );
            }
        } else {
...
//	/**calculates memory predication of given package name*/
//	public int calculateMemoryFreedPredication(String packageName) {
//		return calculateMemoryFreedPredication(getPids(packageName));
//	}
//
//	/**calculates memory predication of all processes*/
//	public int calculateMemoryFreedPredicationOfAllProcesses() {
//		return calculateMemoryFreedPredication(getPids(null));
//	}
